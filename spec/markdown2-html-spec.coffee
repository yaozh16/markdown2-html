Markdown2Html = require '../lib/markdown2-html'
  ...
  describe "when the markdown2-html:toggle event is triggered", ->
    it "hides and shows the modal panel", ->
      ...
      runs ->
        ...
        markdown2HtmlElement = workspaceElement.querySelector('.markdown2-html')
        expect(markdown2HtmlElement).toExist()

        markdown2HtmlPanel = atom.workspace.panelForItem(markdown2HtmlElement)
